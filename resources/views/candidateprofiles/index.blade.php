...
<div id="exTab2" class="container">
  {{-- Menubar --}}
  <div class="row">
        <div class="col-md-2" style="margin-l">
            <ul>
            ...
            <div class="row">
                <div class="col-md-12">
                <li>
                    <a href="#7" data-toggle="tab">JOBPOSTS</a>
                </li>
                </div>
            </div>
    ...
    <div class="col-md-10">
        ...
        <div class="tab-content ">
            ...
            <div class="tab-pane" id="7">
                <div class="row">
                    <div class="col-sm-8 offset-sm-2">
                        <h1 class="display-3">Job Posts</h1>
                        <div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table class="table table-striped" style="padding: 2">
                                        <thead>
                                            ...
                                            <tbody>
                                                @foreach($employerjobposts as $employerjobpost)
                                                    <tr>
                                                        <td>{{$employerjobpost->company_name}}</td>
                                                        <td>{{$employerjobpost->locality_city}}</td>
                                                        <td>{{$employerjobpost->job_title}}</td>
                                                        <td>{{$employerjobpost->job_type}}</td>
                                                        <td>{{$employerjobpost->job_level}}</td>
                                                        <td>{{$employerjobpost->job_description}}</td>
                                                        <td>{{$employerjobpost->salary_min}}</td>
                                                        <td>{{$employerjobpost->company_url}}</td>
                                                        <td>{{$employerjobpost->company_email}}</td>
