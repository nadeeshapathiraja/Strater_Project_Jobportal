...
class CandidateLanguageController extends Controller
{
    ...
    public function edit(candidate_language $candidate_language)
    {
        //
    }

    
    public function update(Request $request, candidate_language $candidate_language)
    {
        //
    }

    
    public function destroy(candidate_language $candidate_language)
    {
        //
    }
}
